  ...
  function renderTeam() {
    ...
    grid.innerHTML = teamMembers.map(m => `<div class="team-card">
      <div class="team-card-wrapper">
        <img src="${m.photo_url || '/logo.jpg'}" alt="${m.name}" onerror="this.src='/logo.jpg'" style="width:100%; height:100%; object-fit:cover; ${m.name.toLowerCase().includes('kavya') ? 'transform:scale(2.3); transform-origin:5% 45%;' : (m.name.toLowerCase().includes('awani') ? 'transform:scale(2); transform-origin:center 45%;' : '')}">
      </div>
